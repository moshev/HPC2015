...
* Когато чипа е два пъти по-малък можем да вдигнем честотата два-пъти 
...
3. Вала на имплицитният паралелизъм 
...
Еднонишково оптимизирането процесори (и езици!) са отрицание на това ("света е плосък")
